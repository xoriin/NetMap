...
from app.services.notifications import NOTIFICATION_DEFAULTS, load_notification_settings, send_notification
...
def get_notification_settings(
    ...
    return NotificationSettings(**load_notification_settings(db))
...
def update_notification_settings(
    ...
    _save(db, NOTIFICATION_DEFAULTS, payload.model_dump(exclude_unset=True))
    return NotificationSettings(**load_notification_settings(db))
