...
def init_db() -> None:
    from app.models import alert_rule, auth_session, audit_log, device, dhcp_lease, discovery, firewall_event, monitor_history, port_target, relationship, site, subnet, system_setting, topology_group, topology_layout, user  # noqa: F401
